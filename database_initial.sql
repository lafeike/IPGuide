...
insert into IPGuide(IPName,iptype) values
('Algiers', 'IPs'), ('Afganistan', 'IPs'), ('Angola', 'IPs'), ('Austria', 'IPs'), ('Bahrain', 'IPs'), 
('Bangladesh', 'IPs'), ('Belgium-Brussels', 'IPs'), ('Belgium-Federal', 'IPs'), ('Belgium-Flanders', 'IPs'), 
('Belgium-Wallonia', 'IPs'), ('Bosnia', 'IPs'), ('Bulgaria', 'IPs'), ('Cambodia', 'IPs'), ('Cameroon', 'IPs'), 
('Canada Quebec (in French)', 'IPs'), ('Canada NB', 'IPs'), ('Canada MT', 'IPs'), ('Canada SK', 'IPs'), 
('Canada MB', 'IPs'), ('Canada BC', 'IPs'), ('Canada PEI', 'IPs'), ('Canada NS', 'IPs'), ('Canada NWT', 'IPs'), 
('Canada-NF& LB', 'IPs'), ('Canada-Alberta', 'IPs'), ('Chile', 'IPs'), ('Columbia', 'IPs'), 
('Costa Rica', 'IPs'), ('Croatia', 'IPs'), ('Cyprus', 'IPs'), ('Czech', 'IPs'), ('Denmark', 'IPs'), 
('Dominican Republic', 'IPs'), ('Egypt', 'IPs'), ('El Salvador', 'IPs'), ('Ecuador', 'IPs'), ('Ethiopia', 'IPs'), 
('Eastonia', 'IPs'), ('Finland', 'IPs'), ('Georgia', 'IPs'), ('Ghana', 'IPs'), ('Guam', 'IPs'), ('Greece', 'IPs'), 
('Holland', 'IPs'), ('Honduras', 'IPs'), ('Hong Kong', 'IPs'), ('Hungary', 'IPs'), ('Israel', 'IPs'), ('Iraq', 'IPs'), 
('Iran', 'IPs'), ('Jordan', 'IPs'), ('Kazakhstan', 'IPs'), ('Kenya', 'IPs'), ('Khuzestan', 'IPs'), ('Korea', 'IPs'), 
('Kurdistan', 'IPs'), ('Kuwait', 'IPs'), ('Kyrgyzstan', 'IPs'), ('Latvia', 'IPs'), ('Lebanon', 'IPs'), ('Libya', 'IPs'),
 ('Le Reunion', 'IPs'), ('Lithuania', 'IPs'), ('LuXmbourg', 'IPs'), ('Marshall Island', 'IPs'), ('Mongolia', 'IPs'), 
 ('Morocco', 'IPs'), ('Myanmar', 'IPs'), ('New Zealand', 'IPs'), ('Nigeria', 'IPs'), ('Northern Ireland', 'IPs'), 
 ('Norway', 'IPs'), ('Oman', 'IPs'), ('Pakistan ', 'IPs'), ('Paraguay', 'IPs'), ('Panama', 'IPs'), ('Papua New Guinea', 'IPs'), 
 ('Peru', 'IPs'), ('Phillipines', 'IPs'), ('Portugal', 'IPs'), ('Qatar', 'IPs'), ('Rwanda', 'IPs'), ('Romania', 'IPs'), 
 ('Saskatchewan', 'IPs'), ('Saudi Arabia', 'IPs'), ('Senegal', 'IPs'), ('Serbia', 'IPs'), ('Slovakia', 'IPs'),
  ('Slovenia', 'IPs'), ('Sri Lanka', 'IPs'), ('Switzerland', 'IPs'), ('Sweden', 'IPs'), ('Syria', 'IPs'),
   ('Taiwan', 'IPs'), ('Tanzania', 'IPs'), ('Tunisia', 'IPs'), ('Trinidad', 'IPs'), ('Turkey', 'IPs'), 
   ('Ukraine', 'IPs'), ('United Arab Em.', 'IPs'), ('Uruguay', 'IPs'), ('Venezuela', 'IPs'), ('Vietnam', 'IPs'), 
   ('Yemen', 'IPs' );
...
-- 4 import request record data
	...
	--1) IPs request
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Polaris Seismic Int' ) cl where ip.ipname in('Mongolia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Parker Drilling' ) cl where ip.ipname in('Iraq', 'Kazakhstan', 'Khuzestan', 'PapuaNewGuinea', 'Trinidad') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Agrium' ) cl where ip.ipname in('CanadaSK', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Calfrac WellServices' ) cl where ip.ipname in('CanadaSK', 'Canada-Alberta', 'Columbia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Teva Pharma' ) cl where ip.ipname in('Chile', 'Peru', 'Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Calmena' ) cl where ip.ipname in('Columbia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Juniper Networks' ) cl where ip.ipname in('Columbia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Carnegie Mellonuni' ) cl where ip.ipname in('SaudiArabia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Sempra' ) cl where ip.ipname in('Chile', 'Peru') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='TRC' ) cl where ip.ipname in('Trinidad') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Barrick Gold' ) cl where ip.ipname in('Pakistan', 'Peru', 'Tanzania') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Siemens' ) cl where ip.ipname in('SaudiArabia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Novachemical' ) cl where ip.ipname in('Chile') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Clorox' ) cl where ip.ipname in('') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='SNCLavalin' ) cl where ip.ipname in('Algiers', 'Columbia', 'Kenya', 'Libya', 'Nigeria') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Williams Energy' ) cl where ip.ipname in('Columbia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Centerra Gold' ) cl where ip.ipname in('Mongolia', 'Pakistan') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='AnteaGroup(DeltaConsult)' ) cl where ip.ipname in('Hungary', 'Romania') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Konecranes' ) cl where ip.ipname in('Chile', 'Columbia', 'Peru') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='MacAndrews&ForbesHoldinginc' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Deloitte' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Ernst & Young' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Transcanada Pipeline' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Direct Energy' ) cl where ip.ipname in('CanadaSK') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Banda Group' ) cl where ip.ipname in('Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Solar Turbines' ) cl where ip.ipname in('Czech') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='John Crane' ) cl where ip.ipname in('') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='AON' ) cl where ip.ipname in('Belgium-Flanders', 'Belgium-Wallonia', 'Chile') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='CHS Inc' ) cl where ip.ipname in('Ukraine') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Saint Gobain Norpro' ) cl where ip.ipname in('Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='CenterraGold, TorontoOntario' ) cl where ip.ipname in('Kyrgyzstan', 'Mongolia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='PikaInternational Inc' ) cl where ip.ipname in('Kuwait') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Fruit of the Loom' ) cl where ip.ipname in('ElSalvador', 'Honduras') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Transalta' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Chevron' ) cl where ip.ipname in('Peru', 'SaudiArabia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Invista' ) cl where ip.ipname in('Columbia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Gates International(Corp.)' ) cl where ip.ipname in('Belgium-Flanders', 'Belgium-Wallonia', 'Czech', 'Turkey') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Norbrook Labs' ) cl where ip.ipname in('Czech', 'Kenya') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='CFIndustires' ) cl where ip.ipname in('') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Styrolution' ) cl where ip.ipname in('Belgium-Flanders', 'Belgium-Wallonia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Devon Energy' ) cl where ip.ipname in('CanadaSK', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Hanes' ) cl where ip.ipname in('CostaRica', 'DominicanRepublic', 'ElSalvador', 'Honduras', 'SriLanka', 'Vietnam') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Fenwel' ) cl where ip.ipname in('Austria', 'Belgium-Flanders', 'DominicanRepublic', 'Tunisia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Lubrizol' ) cl where ip.ipname in('Belgium-Flanders', 'Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='URS' ) cl where ip.ipname in('Guam') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Avery Dennison' ) cl where ip.ipname in('Belgium-Flanders', 'Belgium-Wallonia', 'Czech', 'Turkey') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='McMahon&Degullis(STCClient)' ) cl where ip.ipname in('Belgium-Flanders', 'Belgium-Wallonia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Chevron Phillips' ) cl where ip.ipname in('Belgium-Wallonia', 'Qatar', 'SaudiArabia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Sealed Air' ) cl where ip.ipname in('Columbia', 'Israel', 'NewZealand', 'Portugal', 'Taiwan', 'Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Delphi Corporation' ) cl where ip.ipname in('Austria', 'Belgium-Flanders', 'Belgium-Wallonia', 'Czech', 'Hungary', 'LuXmbourg', 'Morocco', 'Portugal', 'Romania', 'Slovakia', 'Turkey') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Hoffman LaRoche' ) cl where ip.ipname in('Norway', 'Panama', 'Peru', 'Uruguay', 'Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Hoffman LaRoche' ) cl where ip.ipname in('Vietnam') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Environ' ) cl where ip.ipname in('Georgia', 'Oman', 'Peru') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Environ' ) cl where ip.ipname in('Denmark', 'Sweden') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Occidental Petroleum' ) cl where ip.ipname in('Chile', 'Oman', 'Qatar') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Parker Drilling' ) cl where ip.ipname in('Columbia', 'Czech', 'Egypt', 'Holland', 'Iraq', 'Kazakhstan', 'Kurdistan', 'PapuaNewGuinea', 'SaudiArabia', 'Trinidad', 'Turkey') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='HESS Corporation' ) cl where ip.ipname in('Denmark') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Chevron' ) cl where ip.ipname in('Qatar') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Redco Construction' ) cl where ip.ipname in('Qatar') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Seagate' ) cl where ip.ipname in('Belgium-Flanders') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Van Breusegen & Associates' ) cl where ip.ipname in('CostaRica', 'Trinidad', 'Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Danaher Corp.' ) cl where ip.ipname in('Belgium-Flanders', 'Czech', 'Denmark', 'Norway', 'Slovakia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='EXlis' ) cl where ip.ipname in('Afganistan', 'Iraq', 'Qatar') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Mosaic' ) cl where ip.ipname in('Saskatchewan') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='AGC Glass' ) cl where ip.ipname in('Saskatchewan') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Jarden' ) cl where ip.ipname in('Chile', 'Columbia', 'Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Mead Westvaco' ) cl where ip.ipname in('Czech', 'Hungary') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Dresser Rand' ) cl where ip.ipname in('Angola', 'Morocco', 'Nigeria', 'Norway', 'SaudiArabia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Ecolab' ) cl where ip.ipname in('Angola', 'DominicanRepublic', 'Korea', 'Nigeria', 'Phillipines', 'Qatar', 'Slovenia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Ecolab' ) cl where ip.ipname in('Canada-Alberta', 'Ecuador') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Smith Management Group' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Borden Ladner Gervais' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='GE' ) cl where ip.ipname in('') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Jost Chemical' ) cl where ip.ipname in('Belgium-Flanders') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Axalta' ) cl where ip.ipname in('Belgium-Flanders', 'Turkey', 'Venezuela') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Agrium' ) cl where ip.ipname in('CanadaMT', 'CanadaSK') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Atlas Copco' ) cl where ip.ipname in('Belgium-Flanders', 'Belgium-Wallonia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Schneider Electric' ) cl where ip.ipname in('Algiers', 'Austria', 'Bahrain', 'Bangladesh', 'Belgium-Flanders', 'Belgium-Wallonia', 'Bosnia', 'Bulgaria', 'Cambodia', 'Cameroon', 'CanadaNB', 'CanadaMT', 'CanadaSK', 'CanadaPEI', 'CanadaNWT', 'Canada-NF&LB', 'Canada-Alberta', 'Chile', 'Columbia', 'CostaRica', 'Croatia', 'Cyprus', 'Czech', 'Denmark', 'DominicanRepublic', 'Egypt', 'Ecuador', 'Eastonia', 'Finland', 'Greece', 'Hungary', 'Iraq', 'Iran', 'Jordan', 'Kazakhstan', 'Kuwait', 'Latvia', 'Lebanon', 'Libya', 'LeReunion', 'Lithuania', 'Mongolia', 'Morocco', 'Myanmar', 'Nigeria', 'Norway', 'Oman', 'Pakistan', 'Paraguay', 'Peru', 'Phillipines', 'Portugal', 'Qatar', 'Romania', 'SaudiArabia', 'Senegal', 'Serbia', 'Slovakia', 'Slovenia', 'SriLanka', 'Syria', 'Tunisia', 'Turkey', 'Ukraine', 'Uruguay', 'Venezuela', 'Vietnam', 'Yemen') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Williams Energy Services' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='AirProducts' ) cl where ip.ipname in('Canada-Alberta', 'Peru') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Hayes Lemmerz' ) cl where ip.ipname in('Czech', 'Turkey') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Panasonic-Japan' ) cl where ip.ipname in('') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Remy International' ) cl where ip.ipname in('CanadaMT', 'Tunisia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='MEG Energy' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Cabot Corp.' ) cl where ip.ipname in('Belgium-Flanders', 'Latvia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Rolls Royce' ) cl where ip.ipname in('Finland', 'Norway', 'Vietnam') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Tetra Tech' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Tervita' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Parkland Pipeline' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Glaxo Smith Kline' ) cl where ip.ipname in('Ethiopia', 'Ghana', 'Kenya', 'Nigeria', 'Rwanda') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Amec' ) cl where ip.ipname in('CanadaSK', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Beam Global Spirits' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='GWL Realty Advisors' ) cl where ip.ipname in('CanadaSK', 'CanadaMB', 'CanadaBC', 'CanadaNS', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Gulf Drilling International' ) cl where ip.ipname in('Qatar') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='RPS Group' ) cl where ip.ipname in('CanadaNB', 'CanadaSK', 'CanadaNS', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Cardinal Health' ) cl where ip.ipname in('CanadaNB', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='ERM Calgary' ) cl where ip.ipname in('CanadaBC', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Momentive Performance Materials' ) cl where ip.ipname in('Belgium-Flanders', 'Canada-Alberta', 'Columbia', 'Czech', 'Turkey') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Asco Aerospace' ) cl where ip.ipname in('Belgium-Federal', 'Belgium-Flanders', 'Belgium-Wallonia', 'CanadaBC') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='General Mills' ) cl where ip.ipname in('CanadaQuebec(inFrench)', 'CanadaSK', 'CanadaMB', 'Greece', 'NewZealand', 'Taiwan') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='North American Terminal Services' ) cl where ip.ipname in('Columbia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Merck' ) cl where ip.ipname in('Belgium-Brussels') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Clifton Associates' ) cl where ip.ipname in('CanadaSK', 'Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Hologic' ) cl where ip.ipname in('CostaRica') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Exxon Mobil' ) cl where ip.ipname in('Sweden') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Arrmaz Custom Chemicals' ) cl where ip.ipname in('SaudiArabia') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Sikorsky Aircraft' ) cl where ip.ipname in('Czech') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Concurrent Technologies Corp.' ) cl where ip.ipname in('CanadaBC') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Textron' ) cl where ip.ipname in('Czech', 'Romania', 'Switzerland', 'UnitedArabEm.') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Columbian Chemicals' ) cl where ip.ipname in('Chile', 'Czech', 'Hungary') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Ashland' ) cl where ip.ipname in('Belgium-Federal', 'Finland') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Inter Oil Corporation' ) cl where ip.ipname in('Canada-Alberta') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='RPM International' ) cl where ip.ipname in('Belgium-Flanders') and ip.iptype='IPs';
insert into IPGuideRequestRecord(ip_id,client_id,iptype) select ip.id,cl.clientid,'IPs' from IPGuide ip cross join (select max(id) clientid from IPGuideRequestClient where ClientName='Xylem' ) cl where ip.ipname in('Panama', 'Portugal', 'Turkey', 'Venezuela') and ip.iptype='IPs';
